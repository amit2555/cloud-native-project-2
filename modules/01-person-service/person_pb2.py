...
_PERSONMESSAGELIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='person', full_name='PersonMessageList.person', index=0,
...
_PERSONMESSAGELIST.fields_by_name['person'].message_type = _PERSONMESSAGE
